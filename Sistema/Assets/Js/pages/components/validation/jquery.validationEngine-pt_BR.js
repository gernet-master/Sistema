    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": {
                    "regex": "none",
                    "alertText": xmlLang("sc1", 2).Text,
                    "alertTextCheckboxMultiple": "Selecione uma opção",
                    "alertTextCheckboxe": xmlLang("sc1", 2).Text,
                ...
                "minSize": {
                    "regex": "none",
                    "alertText": xmlLang("sc2", 2).Text,
                    "alertText2": xmlLang("sc3",0).Text
                },
                "maxSize": {
                    "regex": "none",
                    "alertText": xmlLang("sc4", 2).Text,
                    "alertText2": xmlLang("sc3",0).Text
                },
				"groupRequired": {
                    "regex": "none",
                ...
                "date": {
                    ...
                    "alertText": xmlLang("sc10", 2).Text
                },
                "ipv4": {
                    "regex": /^((([01]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))[.]){3}(([0-1]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))$/,
                    "alertText": xmlLang("sc8", 2).Text
                },
                "url": {
                    "regex": /[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/,
                    "alertText": xmlLang("sc9", 2).Text 
                },
                "onlyNumberSp": {
                    "regex": /^[0-9\ ]+$/,
				...
				"cpf": {
                    "regex": "none",
                    "alertText": xmlLang("sc11", 2).Text 
                },
				"cnpj": {
                    "regex": "none",
                    "alertText": xmlLang("sc12", 2).Text 
                },
            };
